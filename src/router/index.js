...
router.beforeEach(async (to, from, next) => {
  ...
  if (isMaintenance) {
    ...
    const maintenanceRoutes = ['/login', '/register', '/register/lengkapi-profil'];
  ...
  const isAuthenticated = getFromStorage('user-role') === 'user';
  const isAdmin = getFromStorage('user-role') === 'admin';
